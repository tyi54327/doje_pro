...
<section class="sec-3">
    ...
    <div class="login-form">
        <form id="form2" method="post" action="test.jsp">
            <input type="text" placeholder="회원명을 입력해주세요" id="id" class="text-fld" name="search_name" required>
           	<input type="submit" value="검색" class="submit-btn" id="but">
		</form>
    </div>
</section>
