...
<body>
    <header class="header-1">
        <h1>Hyundai The Premium Seoul Outlet Customer delete Page</h1>
    ...
    <section class="sec-3">
        <br>
        <h1 class="login-t">회원 탈퇴</h1>
        <div class="login-form" >
        <form method="post" action="test2.jsp"  id="form2" >
              <input type="text" placeholder="회원명을 입력해주세요" id="id" class="text-fld" name="delete_name">
              <input type="submit" value="탈퇴" class="submit-btn">
        </form>
        </div>
      </section>
